      ...
      <div className="login-box-sister" style={{ 
        ...
        <form onSubmit={handleLogin}>
          <div style={{ marginBottom: '16px' }}>
            <label style={{ display: 'block', fontWeight: 800, fontSize: '0.7rem', color: '#005596', letterSpacing: '0.5px', marginBottom: '8px', textTransform: 'uppercase' }}>Username / Email</label>
            <input 
              type="text" 
